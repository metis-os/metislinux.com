...
- Three new repo structure read more [here](https://metislinux.org/docs/guides/repos)

Things that have been removed
- Probably one and only thing, the metis-sideload way to install metislinux.

I guess this is it for this time. Thank you all, and stay tuned for more exciting updates on MetisLinux in the future!
