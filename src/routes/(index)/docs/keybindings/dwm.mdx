...
• MOD + grave: Toggle second st scratchpad terminal
...
• MOD + shift + x: Poweroff/Reboot selection menu

Get the offline file of [Key Bindings Pdf!](https://metislinux.org/assets/images/pdfs/metis-dwm-keybinds.pdf)